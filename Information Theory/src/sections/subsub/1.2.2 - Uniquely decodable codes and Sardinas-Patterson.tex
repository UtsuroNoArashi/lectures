...
\begin{document}
    Non-singular codes are not enough. 
        More often than not, it happens that the sequence of bit in analysis may be factored in
        as concatenation of distinct codewords, one again making the decoding process tedious. 

    Briefly speaking, what we are looking for are codes for which any sequece of codewords
    ...
    Hence the questions: how do we construct UD codes?
        And how do we determine if a given code is UD? 
