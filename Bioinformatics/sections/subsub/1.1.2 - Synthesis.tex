...
\begin{document}
    ...
    What we just described assumes no error occurs during DNA replication.
        As easily understood this is rarely the case. In fact, if errors did not occur,
        evolution would be impossible. More in general, when dealing with DNA sequences we have to consider 
