\documentclass{subfiles} \begin{document}
    ...
    For this particular reason, an \emph{encoder} is used to convert the source alphabet,
    ...
    Before we consider any specific type of \emph{code},
    ...
    \begin{example*}
        ...
        \subfile{../../extra/TikZ/Example - Non non-singular codes}
