...
\begin{document}
    ...
    \begin{proposition*}
        ...
        \begin{enumerate}
            ...
            \item Each ideal \(I\) of \(R\) is finitely generated.
            \item However took a family \(\F*\) of ideals of \(R\); 
                \(\F*\) admits maximum. 
        \end{enumerate}
    \end{proposition*}
    ...
    \begin{proof*}
        \begin{description}
            \item [\((2 \implies 1)\):] Let \(I_{1} \subseteq I_{2} \subseteq 
            ...
            \item [\((1 \implies 3)\):] Consider \(\F*\) be a non-empty family of ideals.
            ...
            \item [\((3 \implies 2)\):] Let \(I \subseteq R\) be an ideal, 
                ...
                Trivially, \(\F* \ne \varnothing\). Let \(I_{MAX}\) be the maximal element in \(\F*\).
                    ...
                    meaning \(I_{MAX}\) isn't the maximal element, which is absurd.
        \end{description}
    \end{proof*}
    ...
    \begin{proof*}
        ...
        \]
        the statement is true by the previously discussed proposition.
    \end{proof*}
    ...
    \begin{proof*}
        Simply consider the family 
            ...
            \]
            Since \(R\) is Noetherian, then \(\F*\) must admit a maximal element.
    \end{proof*}
\end{document}
