...
\begin{document}
    ...
    \begin{example*}
        Say out TTP chose \(p = 47\) and \(\gamma = 3\). 
            To compute their public key \(\alpha =  \gamma^{a}, \mathcal{A}\) 
            chooses \(a = 27\). Hence, the value \(\alpha = 34\) is known on the channel.

        Let \(m = 45\) be the message \(\mathcal{B}\) wants to send to \(\mathcal{A}\),
            and to compute \(c_{1}, c_{2}\) they choose \(k = 11\). Then, we have 
            \[
                c_{1} \equiv 4 \mod{p} \qquad c_{2} \equiv 5 \mod{p}.
            \]

        Upon recieving the pair \((c_{1}, c_{2})\) can easely decode \(m\). 
            Observe that, \(x \equiv c_{1}^{a} \equiv 21 \mod{47}\) and 
            it can be easely checked that \(x^{-1} = 9\). 
