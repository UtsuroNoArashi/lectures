...
\begin{document}
    Proposed in 1970, the Needleman-Wunsh algorithm allows one to compute the best global alignment 
    ...
    Let \(s_{1}\) and \(s_{2}\) be the sequences to align, also let \(n, m\) be the respective lengths.
    ...
    \begin{enumerate}
        ...
        \item Within the last row, or column, dind the cell with the maximum score/s;
            from it track the best path/s proceeding backwards.
    \end{enumerate}
\end{document}
