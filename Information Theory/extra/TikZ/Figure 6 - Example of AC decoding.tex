...
\begin{document}
    \begin{figure}[!hb]
        ...
        \begin{tikzpicture}
            ...
            \node at (2.25 + 0.125, 0.75) [label=right:{$\omega = a$}] {};
            ...
            \node at (4.5 + 0.125, 1.875) [label=right:{$\omega = ab$}] {};
            ...
            \node at (6.75 + 0.125, 0.75) [label=right:{$\omega = aba$}] {};
            ...
            \node at ($(32.east) +(0.625, 0.375)$) [label=right:{$\omega = abac$}] {};
        \end{tikzpicture}
        \caption{Step by step decoding of \(x = 0.3047\) via the AC.}
        \label{Fig:6}
    \end{figure}
\
