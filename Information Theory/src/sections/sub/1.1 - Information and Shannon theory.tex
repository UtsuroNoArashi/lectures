...
\begin{document}
    Above we've used the term information assuming is meaning as given; 
        it should be clear that the notion of information in the spoken language
        has little to do with the CS counterpart. 

    Formaly, the notion of information is that of a measure of the
    ...
    With his paper, Shannon introduces introduces two important hypotesis:
        \begin{itemize}
            \item Each symbol transmission requires a non-zero amount of time;
    ...
    But how do we actually measure information? According to Shannon, 
        ...
        the probability associated woth the \(i\)-th symbol produced and \(K\) a 
    ...
    Although we could prove that \Cref{eq:shannonEntropy} is the only valid measure,
        it is beyond our scope; we remind the interested reader to \cite{shannon1948}[Appendix 2].
\end{document}
