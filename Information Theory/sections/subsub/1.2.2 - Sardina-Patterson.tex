...
\begin{document}
    The \emph{Sardinas-Patterson} algorithm provides a way to check whether a code is UD or not. 
        ...
        if \(w\) is a string made up of codewords and we try to factorize it in, 
        say two, distinct factorizations; each word in one factorization is 
        either part of a word in the other factorization or starts with a prefix
        that is suffix of a word in the other factorization.
