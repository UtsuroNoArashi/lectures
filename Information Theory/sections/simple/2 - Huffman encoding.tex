...
\begin{document}\label{Sec:2}
    ...
    Before analyzing his method, it is of interest to point out some properties that optimal codes must satisfy.
        Let \(S\) be a source with probability distribution \(\{p_{1}, p_{2}, \ldots, p_{n}\}\),
        ordered such that \(p_{1} \ge p_{2} \ge \ldots \ge p_{n}\).
        Let \(\C*\) be a compact prefix code for \(S\), and let \(c_{i}\) denote the codeword 
        associated with symbol of probability \(p_{i}\). Then:
        \begin{enumerate}
